...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("FBI Logistics");
        // enable back button
        ...
        binding.tvSigin.setOnClickListener(new View.OnClickListener() {
            @Override
...
//        });
                            ...
                            query.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    ...
                                    for (DataSnapshot ds : snapshot.getChildren()) {
                                        ...
                                        switch (position){
                                            case "AIR":
                                                startActivity(new Intent(SignInActivity.this, AirPageActivity.class));
                                                break;
                                            case "DOM":
                                                startActivity(new Intent(SignInActivity.this, DomActivity.class));
                                                break;
                                            case "LOG":
                                                startActivity(new Intent(SignInActivity.this, LogProActivity.class));
                                                break;
                                            case "IMPORT":
                                                startActivity(new Intent(SignInActivity.this, ProImportActivity.class));
                                                break;
                                            case "SALE":
                                                startActivity(new Intent(SignInActivity.this, SaleActivity.class));
                                                break;
                                            case "FCL":
                                                startActivity(new Intent(SignInActivity.this, FclActivity.class));
                                                break;
                                            default:
                                                startActivity(new Intent(SignInActivity.this, RegisterActivity.class));
                                                break;
    ...
    private void sendUserToDashboardActivity() {
        Intent dashboarIntent = new Intent(SignInActivity.this, MainActivity.class);
