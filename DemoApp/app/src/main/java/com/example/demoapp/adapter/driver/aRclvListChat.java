    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        if(item.getMembersList().size() > 2){
            ...
            if (item.getMembersList().size() == 3) {
                ...
                if(account1 != null){
                    ...
                    if(account1.getLocalAvatar().matches("")){
                        Glide.with(context).load(account1.getImage())
                ...
                if(account2 != null){
                    ...
                    if(account2.getLocalAvatar().matches("")){
                        Glide.with(context).load(account2.getImage())
                                .placeholder(R.drawable.no_avatar)
                                .dontAnimate().apply(RequestOptions.circleCropTransform())
                ...
                if(account3 != null){
                    if(account3.getLocalAvatar().matches("")){
                        Glide.with(context).load(account3.getImage())
                                .placeholder(R.drawable.no_avatar)
                                .dontAnimate().apply(RequestOptions.circleCropTransform())
            ...
            //more than 3
                ...
                objAccount account1 = objAccount.getAccountFromSQLite(context,item.getMembersList().get(0));
                if(account1 != null){
                    Glide.with(context).load(account1.getLocalAvatar().matches("") ? account1.getImage() : account1.getLocalAvatar())
                            .placeholder(R.drawable.no_avatar)
                            .dontAnimate().apply(RequestOptions.circleCropTransform())
                            .into(holder.imvAvatar1);
                }
                ...
                objAccount account2 = objAccount.getAccountFromSQLite(context,item.getMembersList().get(1));
                if(account2 != null){
                    Glide.with(context).load(account2.getLocalAvatar().matches("") ? account2.getImage() : account2.getLocalAvatar())
                            .placeholder(R.drawable.no_avatar)
                            .dontAnimate().apply(RequestOptions.circleCropTransform())
                            .into(holder.imvAvatar2);
                }
                ...
                objAccount account3 = objAccount.getAccountFromSQLite(context,item.getMembersList().get(2));
                if(account3 != null){
                    Glide.with(context).load(account3.getLocalAvatar().matches("") ? account3.getImage() : account3.getLocalAvatar())
                            .placeholder(R.drawable.no_avatar)
                            .dontAnimate().apply(RequestOptions.circleCropTransform())
                            .into(holder.imvAvatar3);
                }
            ...
            if(account != null){
                Glide.with(context).load(account.getLocalAvatar().matches("") ? account.getImage() : account.getLocalAvatar())
                        .placeholder(R.drawable.no_avatar)
                        .dontAnimate().apply(RequestOptions.circleCropTransform())
