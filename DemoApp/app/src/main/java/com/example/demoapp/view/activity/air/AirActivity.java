...
public class AirActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAirBinding.inflate(getLayoutInflater());
        ...
        switch (item.getItemId()) {
            ...
            case R.id.tab_chat:
                if(mCurrentFragment != MESSAGE){
                    startActivity(new Intent(AirActivity.this, DashboardActivity.class));
                    finish();
                }
                break;
