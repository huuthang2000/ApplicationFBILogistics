...
public interface imp_Chat {
     ...
     */
    void uploadImageToFolderMessage(final int position, final String pathImage, final pre_Chat.onResultUploadImage result);
     ...
     */
    void findChatIDByUid(final String Uid, @NonNull final pre_Chat.onResultFindChatIDByUid result);
