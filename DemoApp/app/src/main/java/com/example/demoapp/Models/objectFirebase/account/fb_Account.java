...
public class fb_Account {
    ...
    public fb_Account(String avatar, String email, fb_Gps gps, String keyToken, fb_Location location, String name, String phone, String batteryPercent, String gender, String status, String network, long timeCreate, boolean bought, String type) {
        this.avatar = avatar;
        this.email = email;
        this.gps = gps;
    ...
    public fb_Account(String avatar, String email, fb_Gps gps, String keyToken, fb_Location location, String name, String phone, String batteryPercent, String gender, String status, String network, String type) {
        this.avatar = avatar;
        this.email = email;
        this.gps = gps;
        this.keyToken = keyToken;
