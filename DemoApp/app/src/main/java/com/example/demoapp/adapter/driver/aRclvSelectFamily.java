...
public class aRclvSelectFamily extends RecyclerView.Adapter<aRclvSelectFamily.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(sizeMemberList == 1){
            ...
            Glide.with(context)
                    .load(account.getLocalAvatar().matches("") ? account.getImage() : account.getLocalAvatar())
            ...
            Glide.with(context)
                    .load(account1.getLocalAvatar().matches("") ? account1.getImage() : account1.getLocalAvatar())
                    .placeholder(R.color.colorLine)
                    .error(R.drawable.no_avatar)
                    .dontAnimate().apply(RequestOptions.circleCropTransform())
            ...
            Glide.with(context)
                    .load(account2.getLocalAvatar().matches("") ? account2.getImage() : account2.getLocalAvatar())
                    .placeholder(R.color.colorLine)
                    .error(R.drawable.no_avatar)
                    .dontAnimate().apply(RequestOptions.circleCropTransform())
